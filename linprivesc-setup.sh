...
echo "==This command is added by alimran13==" 
echo "==Setting Capabilities to binary /usr/bin/python2.6.=="
apt-get install libcap2-bin &>/dev/null
setcap cap_setuid+ep /usr/bin/python2.6 &>/dev/null
